pipeline {
    ...
    stages {
        ...
        stage('build local repo') {
            steps {
                sh 'mvn deploy:deploy-file -Durl=file:///repo -Dfile=/repo/*.jar -DgroupId=net.stickycode.deploy -DartifactId=sticky-deployer-embedded -Dpackaging=jar -Dversion=0.9'
           }
        }
